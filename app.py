# -*- coding: utf-8 -*-
"""Despliegue_Pipes_Inversion_para_videojuegos.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1K6fPJlrJnpAQRy9Er70rFiwWonqdtfhA
...
#pipeline luego de verificar que el código es funcional se comenta

#Cargamos los datos futuros
#data = pd.read_csv("videojuegos-datosFuturos.csv")
#data.head()
# También se comenta luego de realizar la consulta de que el código es funcional
...
#Los datos deben estar en el mismo orden y con el mismo nombre que el df original
